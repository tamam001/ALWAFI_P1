...
def fix_view_modes(action):
    """ For historical reasons, ALWAFI has weird dealings in relation to
...
class ExportFormat(object):
    ...
    def from_data(self, fields, rows):
        """ Conversion method from ALWAFI's export data to whatever the
