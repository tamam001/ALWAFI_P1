...
function ALWAFIEvent(target, name, data) {
    this.target = target;
    this.name = name;
...
ALWAFIEvent.prototype.stopPropagation = function () {
    this.stopped = true;
};

ALWAFIEvent.prototype.is_stopped = function () {
    return this.stopped;
};
...
var EventDispatcherMixin = _.extend({}, ParentedMixin, {
    ...
    trigger_up: function (name, info) {
        var event = new ALWAFIEvent(this, name, info);
