 ...
 * everything concurrency related in ALWAFI.
 *
 * The basic concurrency primitives in ALWAFI JS are the callback, and the
...
return {
    ...
    /**
     * A (ALWAFI) mutex is a primitive for serializing computations.  This is
