 ...
 * Its role is to makes sure that ALWAFI actions are properly started and
 * coordinated.
 */
...
var ActionManager = Widget.extend({
    ...
    /**
     * This is the entry point to execute ALWAFI actions, given as an ID in
     ...
     * @param {ALWAFIEvent} ev.data.controllerID
     */
