...
var CrashManager = core.Class.extend({
    ...
    show_warning: function(error) {
        ...
        return new Dialog(this, {
            size: 'medium',
            title: _.str.capitalize(error.type || error.message) || _t("ALWAFI Warning"),
    ...
    show_error: function(error) {
        ...
        var dialog = new Dialog(this, {
            title: _.str.capitalize(error.type || error.message) || _t("ALWAFI Error"),
...
var RedirectWarningHandler = Dialog.extend(ExceptionHandler, {
    ...
    display: function() {
        ...
        new Dialog(this, {
            size: 'medium',
            title: _.str.capitalize(error.type) || _t("ALWAFI Warning"),
            buttons: [
...
function session_expired(cm) {
    return {
        display: function () {
            cm.show_warning({type: _t("ALWAFI Session Expired"), data: {message: _t("Your ALWAFI session expired. Please refresh the current web page.")}});
        }
    }
}
