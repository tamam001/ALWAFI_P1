...
var FieldMany2One = AbstractField.extend({
    ...
    */
     ...
     *
     * @param {ALWAFIEvent} event 'field_changed' event
     */
...
var FieldX2Many = AbstractField.extend({
     ...
     * @override
     * @param {Object} record
     * @param {ALWAFIEvent} [ev] an event that triggered the reset action
...
var FieldOne2Many = FieldX2Many.extend({
     ...
     * @override
     * @private
     * @param {ALWAFIEvent|MouseEvent} ev this event comes either from the 'Add
