 ...
 * QUnit Config
 *
 * The ALWAFI javascript test framework is based on QUnit (http://qunitjs.com/).
 * This file is necessary to setup Qunit and to prepare its interactions with
 * ALWAFI.  It has to be loaded before any tests are defined.
 *
 * Note that it is not an ALWAFI module, because we want this code to be executed
 * as soon as possible, not whenever the ALWAFI module system feels like it.
 */
