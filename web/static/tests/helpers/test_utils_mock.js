 ...
 * @param {number} [params.debug] if set to true, logs RPCs and uncaught ALWAFI
 *   events.
...
function addMockEnvironment(widget, params) {
    ...
    // make sure all ALWAFI events bubbling up are intercepted
 ...
 * not fire.
 *
 * @param {Widget} widget the target widget (any ALWAFI widget)
