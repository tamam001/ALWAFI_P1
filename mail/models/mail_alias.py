...
class Alias(models.Model):
    """A Mail Alias is a mapping of an email address with a given ALWAFI Document
       model. It is used by ALWAFI's mail gateway when processing incoming emails
       ...
       created, it becomes immediately usable and ALWAFI will accept email for it.
     """
    _name = 'mail.alias'
    ...
    alias_model_id = fields.Many2one('ir.model', 'Aliased Model', required=True, ondelete="cascade",
                                     help="The model (ALWAFI Document Kind) to which this alias "
