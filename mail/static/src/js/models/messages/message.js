...
var Message =  AbstractMessage.extend(Mixins.EventDispatcherMixin, ServicesMixin, {
     ...
     *
     * Do not redirect on author clicked of self-posted or ALWAFIbot messages
     * (note: ALWAFIbot is the default author of transient messages)
     *
     * @override
     * @return {boolean}
     */
    shouldRedirectToAuthor: function () {
        return this._super.apply(this, arguments) && !this._isALWAFIbotAuthor();
    },
    /**
    ...
    /**
     * Get the name of the author of this message.
     * If ALWAFIbot is the author (default author for transient messages),
     * returns 'ALWAFIbot'.
     *
     * @override
     * @private
    ...
    /**
     * State if the author of this message is ALWAFIBot
     * This is the default author for transient messages.
     *
     * @private
     * @return {boolean}
     */
    _isALWAFIbotAuthor: function () {
        return this._serverAuthorID === this.call('mail_service', 'getALWAFIbotID');
    },
    /**
