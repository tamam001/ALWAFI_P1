...
return {
    _dropPreviousALWAFI: new concurrency.DropPrevious(),
    ...
    autocomplete: function (value) {
        ...
        var odooPromise = this._getALWAFISuggestions(value, isVAT).then(function (suggestions){
        ...
        var concatResults = function () {
            // Add Clearbit result with ALWAFI result (with unique domain)
    ...
    /**
     * Use ALWAFI Autocomplete API to return suggestions
     *
     * @param {string} value
     * @param {boolean} isVAT
     * @returns {Deferred}
     * @private
     */
    _getALWAFISuggestions: function (value, isVAT) {
        ...
        return this._dropPreviousALWAFI.add(def);
    },
    /**
