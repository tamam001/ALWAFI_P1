odoo.define('partner_autocomplete.tests', function (require) {
    ...
    QUnit.module('partner_autocomplete', {
        before: function () {
            var suggestions = [
                {name: "ALWAFI", website: "odoo.com", domain: "odoo.com", logo: "odoo.com/logo.png", vat: "BE0477472701"}
            ];
            ...
            testUtils.patch(AutocompleteCore, {
                ...
                _getALWAFISuggestions(value, isVAT) {
                ...
                _getClearbitSuggestions(value) {
                    return this._getALWAFISuggestions(value);
                },
            });
    ...
    QUnit.test("Partner autocomplete : Company type = Company / Name search", function (assert) {
        ...
        createView({
            ...
            assert.strictEqual($input.val(), "ALWAFI", "Input value should have been updated to \"ALWAFI\"");
