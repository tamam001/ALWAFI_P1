...
var LongpollingBus = Bus.extend(ServicesMixin, {
     ...
     * @returns {boolean}
     */
    isALWAFIFocused: function () {
        return this._isALWAFIFocused;
    },
    /**
    ...
    _onFocusChange: function (params) {
        this._isALWAFIFocused = params.focus;
        if (params.focus) {
            this._lastPresenceTime = new Date().getTime();
            this.trigger('window_focus', this._isALWAFIFocused);
        }
    },
    /**
