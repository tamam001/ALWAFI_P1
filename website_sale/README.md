...
ALWAFI is an <a href="https://www.odoo.com/page/e-commerce">Open Source eCommerce</a>
...
ALWAFI's unique *'edit inline'* and building blocks approach makes product pages
...
ALWAFI's upselling algorythm allows you to show visitors similar but more
...
Get a clear visibility of your sales funnel. ALWAFI's Google Analytics trackers
are configured by default to track all kind of events related to shopping
carts, call-to-actions, etc.

As ALWAFI marketing tools (mass mailing, campaigns, etc) are also linked with
...
SEO tools are ready to use, with no configuration required. ALWAFI suggests
...
Create new landing pages easily with the ALWAFI inline edition feature. Send
...
Benefit from the power of ALWAFI, in your online store: a powerfull tax engine,
...
Everything is integrated with ALWAFI. No pain, real time.
