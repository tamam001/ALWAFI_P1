...
class IrActionsServer(models.Model):
    ...
    Since ALWAFI 8.0 a button 'Create Menu Action' button is available on the
...
#  - env: ALWAFI Environment on which the action is triggered
#  - model: ALWAFI Model of the record on which the action is triggered; is a void recordset
