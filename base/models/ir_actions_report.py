...
# here to init the T1 fonts cache at the start-up of ALWAFI so that rendering of barcode in multiple
...
# Check the presence of Wkhtmltopdf and return its version at ALWAFI start-up
...
try:
    ...
    if match:
        ...
        if config['workers'] == 1:
            _logger.info('You need to start ALWAFI with at least two workers to print a pdf version of the reports.')
