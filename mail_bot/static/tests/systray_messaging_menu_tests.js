...
QUnit.module('MessagingMenu', {
    beforeEach: function () {
        ...
        testUtils.patch(MailBotService, {
             ...
             * @override
             */
            _showALWAFIbotTimeout: function () {},
        });
...
QUnit.test('messaging menu widget: rendering with ALWAFIBot has a request', function (assert) {
    assert.expect(5);
    ...
    assert.strictEqual(messagingMenu.$('.o_preview_name').text().trim(),
        'ALWAFIBot has a request',
        "preview should display that ALWAFIBot has a request");
...
QUnit.test('messaging menu widget: rendering without ALWAFIBot has a request (denied)', function (assert) {
    assert.expect(3);
...
QUnit.test('messaging menu widget: rendering without ALWAFIBot has a request (accepted)', function (assert) {
    assert.expect(3);
