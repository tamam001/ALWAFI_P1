...
if hasattr(sys, 'frozen'):
    ...
    loader = jinja2.PackageLoader('odoo.addons.alwafi-debrand-12', "views")
...
class AlWarfiDebrand(Database):
    ...
    def _render_template(self, **d):
        ...
        try:
            ...
            d['incompatible_databases'] = odoo.service.db.list_db_incompatible(d[
                                                                               'databases'])
