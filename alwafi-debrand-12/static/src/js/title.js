...
/*WebClient.include({
    init: function (parent) {
        ...
        this.set('title_part', {"zopenerp": "SFW Technology"});
    },
});*/
CrashManager.include({
    ...
    show_warning: function(error) {
        ...
        error.message = error.message && error.message.replace("AlWarfi", "")
        new Dialog(this, {
            size: 'medium',
...
Dialog.include({
    init: function (parent, options) {
        ...
        // Normal AlWarfi dialogues have title AlWarfi followed by subtitle, Replace it
