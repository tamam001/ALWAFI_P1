...

{
    ...
    'description': """
Integrate google document to ALWAFI record.
============================================

This module allows you to integrate google documents to any of your ALWAFI record quickly and easily using OAuth 2.0 for Installed Applications,
